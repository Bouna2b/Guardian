...
import { User, Link as LinkIcon, Bell, Shield, FileText, Moon, Sun, Monitor, X, Plus } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const [profile, setProfile] = useState({
    first_name: 'Bouna',
    last_name: 'Diallo',
    email: 'bounadiallo.epitech@gmail.com',
    dob: '24/06/2002',
    city: 'Bastia',
    country: 'France',
  ...
  const [pseudos, setPseudos] = useState([
    'Bouna2b',
    'Bouna.dbvd',
    'Bouna Alboury Diallo',
    'Bouna Varela Diallo',
    'bouna2bastia',
    'bouna2b06',
    'buildwithbouna',
    'bounadiallo.eitech@gmail.com',
    'bounadiallo.pro@gmail.com',
    'bouna.diallo@epitech.eu',
  ]);
  
  const [exclusions, setExclusions] = useState(['medecin', 'sénégal', 'paris']);
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-lg bg-white/5">
            <div>
              ...
              <div className="text-xs text-white/60 mt-1">Vérifiez votre identité pour activer l'envoi de demandes RGPD.</div>
            </div>
            <a href="/onboarding/kyc" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-sm font-medium">
              Voir le statut
            </a>
          </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-white/5">
            <div>
              ...
              <div className="text-xs text-white/60 mt-1">Signez le mandat pour nous autoriser à agir en votre nom.</div>
            </div>
            <a href="/mandate" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-sm font-medium">
              Consulter
            </a>
          </div>
        </div>
